...
public class DriveMotionMagic extends Command {
    ...
    protected void initialize() {
    	...
    	Robot.driveTrain.driveMotionMagic(distance*Constants.inchToEncoder); //Converts inches to encoder ticks
    }
    ...
    protected boolean isFinished() {
    	return ((Math.abs(distance*Constants.inchToEncoder - Robot.driveTrain.getRightEncoder()) < 200)
