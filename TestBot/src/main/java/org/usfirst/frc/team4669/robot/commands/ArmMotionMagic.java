...
public class ArmMotionMagic extends Command {
  ...
  protected void initialize() {
    ...
    Robot.arm.setMotorPos(Robot.arm.getShoulderMotor(), shoulderPos);
    System.out.println("Setting Elbow Target");
    Robot.arm.setMotorPos(Robot.arm.getElbowMotor(), elbowPos);
    System.out.println("Setting Wrist Target");
    Robot.arm.setMotorPos(Robot.arm.getWristMotor(), wristPos);
  }
