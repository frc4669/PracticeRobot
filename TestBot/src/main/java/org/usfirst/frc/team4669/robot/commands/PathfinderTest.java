...
public class PathfinderTest extends Command {
    ...
    protected void initialize() {
        ...
        leftFollower.configureEncoder(Robot.driveTrain.getLeftEncoder(), 4096, Constants.wheelDiameter);
        leftFollower.configurePIDVA(Constants.driveTrainPID[1], 0, 0, 1 / Constants.maxVel, 0);

        rightFollower.configureEncoder(Robot.driveTrain.getRightEncoder(), 4096, Constants.wheelDiameter);
    ...
    // private void followPath(int i) {
    // Robot.driveTrain.followPath(followerNotifier, leftFollower, rightFollower);
    // }
